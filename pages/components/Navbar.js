 ...
 const toggledropdown=()=>{
    ...
    return (
        <div className='flex justify-center md:flex-row md:justify-start items-center flex-col sticky top-0 bg-white z-10 '>
            ...
            {user.value && <FaRegUserCircle onClick={toggledropdown}  className='text-3xl cursor-pointer' />}
{dropdown && <div className='absolute right-4 bg-pink-300  w-[20vh] p-1 rounded-lg' >
